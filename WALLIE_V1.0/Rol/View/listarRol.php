                        ...
                        <div>
                            <div class="input-field col s12">
                                <select id="opciones" name="opciones">
                                    ...
                                    <option value="Rol_Nombre">Nombre</option>
                                </select>  
                            </div>
                        </div>
                        <div>
                            <div class="input-field">
                                <input placeholder="Escribe" id="a" name="condicion" type="text" class="validate inputModificado" OnKeyUp="buscarRol(this.value, document.getElementById('opciones').value)">
