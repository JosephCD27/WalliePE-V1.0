<?php //no lo quites para optimizar, se cae todo :c
    include "../Controller/controllerDocu.php";
?> 
...
<head> 
    <meta charset="UTF-8">
    <title>Ver Tipos de Documento</title>
...
<body>
    <div class="container">
        <div class="fondoForm">
            <div class="col s12">
                <span class="center titulo1"><h5>Tipos de Documento</h5></span>
                    ...
                    <form method="post">
                        ...
                        <div>
                            <div class="input-field">
                                <input placeholder="Escribe" id="a" name="condicion" type="text" class="validate inputModificado" OnKeyUp="buscarDocu(this.value, document.getElementById('opciones').value)">
                                <label for="a" class="labelModificado">buscar</label>
                            </div>
                        </div>
                        <div class="crear">
                            <a class="modal-trigger btn green tooltipped" data-position="top" data-tooltip="Crear" href="#modalCrudDocu" onclick="crearDocu('crear')"><i class=" material-icons">add_circle</i></a>
                        </div>
                    </form>
                </div>
                <div>
    ...
    <script type="text/javascript" src="../../JS/scriptDocu.js"></script>
