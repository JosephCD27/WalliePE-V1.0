<?php //no lo quites para optimizar, se cae todo :c
    ...
    include "../Controller/controllerElementos.php";
?> 
<!DOCTYPE html>
<html lang="en">
<head> 
...
<body>
    ...
    <div class="content-container">
        ...
        <div class="container">
            <div class="fondo">
                <p class="titulo">Elementos</p>
                <div class="dt-container crear">
                    <?php if (tienePermisoModulo(23)) : ?>
                        <a class="modal-trigger tooltipped" data-position="top" data-tooltip="Crear" href="#modalCrudElemento" onclick="crearElemento('crear')"><i class="fa-solid fa-circle-plus fa-2xl" style="color: #7AE7B4;"></i></a>
                    <?php endif; ?>
                </div>
    ...
    <div id="modalCrudElemento" class="modal">
