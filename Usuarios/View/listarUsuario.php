...
<body>
    ...
    <div class="content-container">
        ...
        <div class="container">
            <div class="fondo">
                ...
                <?php if (tienePermisoModulo(18)) : ?> 
                    <div class="dt-container crear">
                        <a class="modal-trigger tooltipped" data-position="top" data-tooltip="Crear" href="#modalCrudUsuario" onclick="crearUsuario('crear')"><i class="fa-solid fa-circle-plus fa-2xl" style="color: #7AE7B4;"></i></a>
                    </div>
                <?php endif; ?>
    ...
    <div id="ABC">   
        </diV><div id="modalCrudUsuario" class="modal">
