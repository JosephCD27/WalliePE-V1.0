...
include "../Controller/controllerPermisos.php";
?> 
<!DOCTYPE html>
<html lang="en">
<head> 
...
<?php include("../../Navbar/View/navbar.php"); ?>
        ...
        <div class="container">
            <div class="fondo">
                ...
                <div class="dt-container crear">
                    <?php if (tienePermisoModulo(20)) : ?>
                        <a class="modal-trigger tooltipped" data-position="top" data-tooltip="Crear" href="#modalCrudPermiso" onclick="crearPermiso('crear')"><i class="fa-solid fa-circle-plus fa-2xl" style="color: #7AE7B4;"></i></a>
                    <?php endif; ?>
                    </div>
                <table class="table highlight display"  id="identificadorDataTables">
                    ...
                    <div id="tblPermiso" class="lista">
                        <?php
                        include("selectPermiso.php");
                        ?>
                    </div>
                </table>
                </div>
    ...
    <!----------------- Inicio del Modal del CRUD ---------------------------------------->
    <div id="modalCrudPermiso" class="modal">
    ...
    <!----------------- Final del Modal del CRUD ---------------------------------------->

    
    <!----------------- Conexiones con archivos de JavaScript ----------------------------->
    <script type="text/javascript" src="../../JS/scriptPermisos.js"></script>
<!-- JQUERY SCRIPT-->
