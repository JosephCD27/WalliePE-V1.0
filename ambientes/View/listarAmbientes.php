<?php //no lo quites para optimizar, se cae todo :c
    include "../Controller/controllerAmbientes.php";
...
<body>
    ...
    <div class="content-container">
        ...
        <div class="container">
            <div class="fondo">
                <p class="titulo">Ambientes</p>
                <div class="dt-container crear">
                    <?php if (tienePermisoModulo(21)) : ?>
                        <a class="modal-trigger tooltipped" data-position="top" data-tooltip="Crear" href="#modalCrudAmbientes" onclick="crearAmbientes('crear')"><i class="fa-solid fa-circle-plus fa-2xl" style="color: #7AE7B4;"></i></a>
                    <?php endif; ?>
                </div>
                <table class="table highlight display"  id="identificadorDataTables">
                    ...
                    <div id="tblAmbientes" class="lista">
                        <?php
                        include("selectAmbientes.php");
                        ?>
                    </div>
                </table>
            </div>
    ...
    <div id="modalCrudAmbientes" class="modal">
...
<!-----------------Conexiones con archivos de JavaScript----------------------------->
    <script type="text/javascript" src="../../JS/scriptAmbientes.js"></script>
<!-- JQUERY SCRIPT-->
