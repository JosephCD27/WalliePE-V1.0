...
<?php include "../../Navbar/View/navbar.php"; ?>
    <div class="content-container">
        ...
        <div class="container">
            <div class="fondo"">
                <p class="titulo">Tipo documento</p>
                <?php if (tienePermisoModulo(43)) : ?>
                    <div class="dt-container crear">
                        <a class="modal-trigger tooltipped" data-position="top" data-tooltip="Crear" href="#modalCrudDocu" onclick="crearDocu('crear')"><i class="fa-solid fa-circle-plus fa-2xl" style="color: #7AE7B4;"></i></a>
                    </div>
                <?php endif; ?>
                <table class="table highlight display" id="identificadorDataTables2">
                    <thead>
                        <tr>
    ...
    <div id="modalCrudDocu" class="modal">
...
<!-- DATATABLES SCRIPT -->
    ...
    <script>
        $(document).ready(function(){
            $('#identificadorDataTables2').DataTable({
